...
return [
    ...
    */
    ...
    'scripttags' => [
            [
                'src' => env('SHOPIFY_SCRIPTTAG_1_SRC', 'https://amkwebsolutions.com/shopify-app/quantity-break/customer_pricing.js'),
                'event' => env('SHOPIFY_SCRIPTTAG_1_EVENT', 'onload'),
                'display_scope' => env('SHOPIFY_SCRIPTTAG_1_DISPLAY_SCOPE', 'online_store')
            ],
            [
                'src' => env('SHOPIFY_SCRIPTTAG_2_SRC', 'https://amkwebsolutions.com/shopify-app/quantity-break/csp_install_check.js'),
                'event' => env('SHOPIFY_SCRIPTTAG_2_EVENT', 'onload'),
                'display_scope' => env('SHOPIFY_SCRIPTTAG_2_DISPLAY_SCOPE', 'online_store')
            ],
            [
                'src' => env('SHOPIFY_SCRIPTTAG_3_SRC', 'https://amkwebsolutions.com/shopify-app/quantity-break/public/js/cspqb.js'),
                'event' => env('SHOPIFY_SCRIPTTAG_3_EVENT', 'onload'),
                'display_scope' => env('SHOPIFY_SCRIPTTAG_3_DISPLAY_SCOPE', 'online_store')
            ],
    ],
