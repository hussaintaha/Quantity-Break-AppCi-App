...
$(document).ready(function() {
    ...
    function getFind_productData() {
        ...
        var getProductURL = laravelAppURL+"/GetProducts?shop="+shop+"&title="+title;
    ...
    $('#ProductPricingGroup').on('submit', function(e) {
        ...
        $.ajax({
            "type":"POST",
            "url": laravelAppURL+"/SaveData?shop="+shop,
            "data":payload,
            "dataType":'json',
    ...
    $('.showProdutcs').click(function(){
      ...
      var SearrchUrl = laravelAppURL+'/GetDiscountSetProducts?shop='+shop+'&set_id='+setId;
    ...
    function delete_group(set_id){
      ...
      okButton.subscribe(Button.Action.CLICK, () => {
          ...
          $(".loading").show();
            $.ajax({
                "type":"POST",
                "url": laravelAppURL+"/DeleteDiscountSet",
