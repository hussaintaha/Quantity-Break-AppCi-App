            ...
            <div class="Polaris-Header-Title__TitleAndSubtitleWrapper">
              ...
              <div>
                <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;text-align: right;">
                  <button type="submit" class="Polaris-Button Polaris-Button--primary OpenCreateDiv">
                      ...
                      <div class="Polaris-DataTable">
                        ...
                        <div class="Polaris-DataTable__ScrollContainer">
                          ...
                          <table class="Polaris-DataTable__Table">
                            ...
                            <tbody>
                              <?php foreach ($discount_set as $discountSet) {  ?>
                                    ...
                                    <div class="bv-grid">
                                        <div class="bv-grid__column bv-grid__column--half">
                                            <div class="bv-field bv-field--with-input">
                                                ...
                                                <div class="bv-input">
                                                    <input id="bevyField1" class="bv-input__input-element " name="name" type="text" maxlength="50" data-bold-component-id="group-internal-name" value="" required>
                                                </div>
                                    ...
                                    <div class="card-section actions">
                                        <div class="bv-grid group-page-actions">
                                            ...
                                            <div class="bv-grid__column bv-grid__column--half">
                                                ...
                                                <div style="--top-bar-background:#00848e; --top-bar-background-lighter:#1d9ba4; --top-bar-color:#f9fafb; --p-frame-offset:0px;">
                                                  <button type="submit" class="Polaris-Button Polaris-Button--primary" data-bold-component-id="group-save-button" id="ProductPricingGroup">
