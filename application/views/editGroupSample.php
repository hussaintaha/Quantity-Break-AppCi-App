...
<div style="min-height: 500px;"  id="NewPricingGroup">
                  ...
                  <div>
                    ...
                    <div class="Polaris-Header-Title__TitleAndSubtitleWrapper">
                      ...
                      <div class="Polaris-Header-Title">
                        ...
                        <h1 class="Polaris-DisplayText Polaris-DisplayText--sizeLarge">Update Product Pricing Group</h1>
                                            ...
                                            <div class="Polaris-Labelled__LabelWrapper">
                                             ...
                                             <div class="Polaris-Connected">
                                               <div class="Polaris-Connected__Item Polaris-Connected__Item--primary">
                                                 <div class="Polaris-TextField Polaris-TextField--hasValue"><input id="bevyField1" name="name" class="Polaris-TextField__Input"  maxlength="50" data-bold-component-id="group-internal-name" aria-labelledby="bevyField1Label" aria-invalid="false" aria-multiline="false" value="<?= $groupName->set_name ?>" required>
                                                  ...
                                                  <div class="Polaris-Connected">
                                                     <div class="Polaris-Connected_Item Polaris-Connected_Item--primary">
                                                       <div class="Polaris-TextField Polaris-TextField--hasValue">
                                                          <select  id="bevyField2" name="price_type"  class="NewSelector" aria-invalid="false" data-bold-component-id="group-calculation-type">
                                                            <?php
                                                            // $d_prices = $d_prices[0];
                                                            foreach ($d as $rule) { ?>
                                                ...
                                                <div class="Polaris-Stack__Item">
                                                  <div><label class="Polaris-Choice" for="bevyField4"><span class="Polaris-Choice__Control"><span class="Polaris-RadioButton">
                                                    ...
                                                    <div class="Polaris-Choice__Descriptions">
                                                      <div class="Polaris-Choice__HelpText" id="bevyField4HelpText">Custom pricing will apply to specific variants (i.e. Buy 5 of the same Large Red shirt to get price break)</div>
                                                    </div>
                                                  </div>
                                                </div>
                                                <div class="Polaris-Stack__Item">
                                                  <div><label class="Polaris-Choice" for="bevyField5"><span class="Polaris-Choice__Control"><span class="Polaris-RadioButton">
                                                    ...
                                                    <div class="Polaris-Choice__Descriptions">
                                                      <div class="Polaris-Choice__HelpText" id="bevyField5HelpText">Custom pricing will apply to all variants in a product (i.e. Buy ANY 5 shirts (any size, any colour) to receive price break)</div>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
                                          ...
                                          <div class="product-selector">
                                              ...
                                              <div id="selected_products">
                                                ...
                                                <?php foreach ($p->variants as $variant){ ?>
                                                  <input type="hidden" class="<?= $p->p_id ?>  sl_prd prc<?= $p->p_id ?>"  name="<?= $p->p_id ?>[]" value="<?= $variant->variant_id ?>">
                                                <?php } ?>
                                              <?php } ?>
                                              </div>
                                        ...
                                        <div class="qb-displays__controls">
                                          <div class="Polaris-Connected">
                                             <div class="Polaris-Connected_Item Polaris-Connected_Item--primary">
                                               ...
                                               <select id="bevyField6" class="NewSelector" aria-invalid="false" name="custom_display">
